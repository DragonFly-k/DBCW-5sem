create or replace package cwEmpl
as
...
create or replace package body cwEmpl
as
procedure checkEmpAccount(login1 nvarchar2, pass1 nvarchar2, results out number)
as 
begin 
...
ct2 number;
begin
cwEmpl.checkEmpAccount('Ks7631738','Ks7631738',ct2);
...
idd number;
begin
cwEmpl.getCurrentEmplIdAndName('Ks7631738','Ks7631738', idd, fio);
...
cur sys_refcursor;
   ...
   zz zz1;    
begin 
cwEmpl.getComponentsNameAndId(cur);
     loop
      fetch cur into zz;
...
cur sys_refcursor;
   ...
   zz zz1;
begin
cwEmpl.getClientOrdersForEmployeeToDo(1, cur);
     loop
      fetch cur into zz;
      EXIT when cur%notfound;
...
begin
cwEmpl.addMakers('repair type', 100, '10.11.2022');
end;

declare 
n number;
begin
cwEmpl.getLastMakers(n);
