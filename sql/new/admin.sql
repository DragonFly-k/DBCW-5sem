...
-------add data------------------------------
begin
cwPackadm.addstatus('новый');
cwPackadm.addstatus('в обработке');
cwPackadm.addstatus('завершен');
end;

begin
cwPackadm.addvacancy('мастер');
cwPackadm.addvacancy('стажер');
end;

begin
cwPackadm.addComponents('защитное стекло',500);
cwPackadm.addComponents('фронтальная камера',900);
cwPackadm.addComponents('корпус на iphoneX',1500);
cwPackadm.addComponents('процессор',5000);
...
cwPackadm.addemp('Сятковская Екатерина Дмитриевна',1,'MB55555','PBD55A54','Прушинских-4','80297631738','20-09-2022','Ks7631738','Ks7631738');
end;
