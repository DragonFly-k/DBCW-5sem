...
begin
cwpack1.addclient('Syatkovskaya Katsiaryna Dmitrievna', 'Prushinskih, 34', '+375297631738', 'SedSedSed','Password1');
cwpack1.addclient('Syatkovskaya Katsiaryna Dmitrievna', 'Prushinskih, 34', '+375297631738', 'Sed','Pass');
end;

declare
ct number;
begin
cwpack1.getCountOfClientWithSameLogin('SedSedSed', ct);
...
ct3 number;
BEGIN
cwpack1.checkClientAccount('SedSedSed', 'Password1',ct3);
...
idd number;
begin
cwpack1.getClienIdAndName('Sed','Pass', idd, fio);
...
begin
cwpack1.addEquipment('xxxx', '123123','toruble', 1, 'model');
end;

begin
cwpack1.makeOrder(1,1,1,1,'10.11.2022');
end;
