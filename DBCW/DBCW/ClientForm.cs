    ...
    public partial class ClientForm : Form
    {
        ...
        public void insertEmployeeToCombobox()
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.getNameAndIdEmp";
        ...
        public void getClienIdAndName(string login, string pass)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.getClienIdAndName";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void Order(int eq_Id , int client_Id , int empl_Id , int status_id , int maker_id , DateTime dateO )
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.makeOrder";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int getEquipmentId()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.getEpuipmentIdForOrder";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void fillEquipmentTable(string nameBox1, string seriaNumBox2, string descsBox3, string makerBox4, string modelBox5)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.addEquipment";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void showCurrentClientOrders()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.showCurrentClientOrders";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void showHistoryClientOrders()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.showHistoryClientOrders";
                cmd.CommandType = CommandType.StoredProcedure;
