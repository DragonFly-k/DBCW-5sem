...
namespace Client
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(phNumBox3, "Неверный формат номера телефона 80(xx)ххххххх или 375(xx)ххххххх");
            }
        ...
        string checkLogin(string login)
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.getCountOfClientWithSameLogin";
        ...
        public void createNewClient(List<Client> user)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.addclient";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        string getClietnInfo(string login, string password)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack1.checkClientAccount";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("login", OracleDbType.NVarchar2).Value = login;
