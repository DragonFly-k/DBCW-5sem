...
namespace Employeer
{
    public partial class EForm : MaterialForm
    {
        ...
        int amount = 0;
        public EForm(string login, string passw)
        {
            InitializeComponent();
        ...
        public void getCurrentEmpIdAndName(string login, string pass)
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.getCurrentEmplIdAndName";
        ...
        public void getClientOrdersForEmployeeToDo()
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.getClientOrdersForEmployeeToDo";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void getClientOrdersForEmployee()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.getClientOrdersForEmployee";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void insertComponentToCombobox()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.getComponentsNameAndId";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("p_cursor", OracleDbType.RefCursor).Direction = ParameterDirection.Output;
        ...
        private void makeOrder_Click(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(dataGridView1, "Список заказов пуст!");
            }
        }
        public void changeStatusAndMakers(int id_order, int idmk)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.changeStatusAndMakers";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int getLastMakers()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.getLastMakers";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void addMakers(string TypeOfRepair, int Costs, DateTime repairdate)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.addMakers";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void addComponents(int idcomp, int idmaker)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.addComponentsOrder";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void ChangeStatus(int idor)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.changeOrderStatus";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void showHistoryEmpOrders()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwEmpl.getOrdersHistoryForEmployee";
                cmd.CommandType = CommandType.StoredProcedure;
