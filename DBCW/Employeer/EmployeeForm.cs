    ...
    public partial class EmployeeForm : Form
    {
        ...
        public void getCurrentEmpIdAndName(string login, string pass)
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.getCurrentEmplIdAndName";
        ...
        public void getClientOrdersForEmployeeToDo()
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.getClientOrdersForEmployeeToDo";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void getClientOrdersForEmployee()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.getClientOrdersForEmployee";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void insertComponentToCombobox()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.getComponentsNameAndId";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("p_cursor", OracleDbType.RefCursor).Direction = ParameterDirection.Output;
        ...
        public void changeStatusAndMakers(int id_order, int idmk)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.changeStatusAndMakers";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int getLastMakers()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.getLastMakers";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void addMakers(string TypeOfRepair, int Costs, DateTime repairdate)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.addMakers";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void addComponents(int idcomp, int idmaker)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.addComponentsOrder";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void ChangeStatus(int idor)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.changeOrderStatus";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void showHistoryEmpOrders()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new Oracle.ManagedDataAccess.Client.OracleCommand();
                cmd.Connection = conn;
                cmd.CommandText = "sed.cwpack2.getOrdersHistoryForEmployee";
                cmd.CommandType = CommandType.StoredProcedure;
